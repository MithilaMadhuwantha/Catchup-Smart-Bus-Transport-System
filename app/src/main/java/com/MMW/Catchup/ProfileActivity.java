...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void saveUserInformation() {
        ...
        final String displayName = editTextName.getText().toString();
            ...
            user.updateProfile(profile).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Map<String,Object> updateDisplayName = new HashMap<>();
                        updateDisplayName.put("userName",displayName);
                        FirebaseDatabase.getInstance().getReference("User")
                                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).updateChildren(updateDisplayName)
